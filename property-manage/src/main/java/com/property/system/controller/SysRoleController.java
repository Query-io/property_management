...
import com.property.common.core.domain.entity.SysDept;
...
import com.property.framework.web.service.SysPermissionService;
...
public class SysRoleController extends BaseController
{
    ...
    @GetMapping("/nonSystemRoleList")
    public AjaxResult nonSystemRoleList()
    {
        List<SysRole> list = roleService.selectNonSystemRoleList();
        return success(list);
    }
